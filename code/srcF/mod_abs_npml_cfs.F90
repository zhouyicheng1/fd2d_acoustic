...
subroutine abs_cfs_init(fnm_conf)
  ...
  write(200+myid,*) "---- Ax(i) at half and regular points ----"
  do i=nx1,nx2
    write(200+myid,"(i6,2es14.5)") i,Ax_half(i),Ax_regu(i)
  end do
  ! Bx at half and regular
  write(200+myid,*) "---- Bx(i) at half and regular points ----"
  do i=nx1,nx2
    write(200+myid,"(i6,2es14.5)") i,Bx_half(i),Bx_regu(i)
  end do
  ! Dx at half and regular
  write(200+myid,*) "---- Dx(i) at half and regular points ----"
  do i=nx1,nx2
    write(200+myid,"(i6,2es14.5)") i,Dx_half(i),Dx_regu(i)
  end do
  ! (Ax+Dx)*stept at half and regular
  write(200+myid,*) "---- (Ax(i)+Dx(i))*stept at half and regular points ----"
  do i=nx1,nx2
    write(200+myid,"(i6,2es14.5)") i,(Ax_half(i)+Dx_half(i))*stept,(Ax_regu(i)+Dx_regu(i))*stept
  end do
  ...
  do k=nz1,nz2
    write(200+myid,"(i6,2es14.5)") k,Az_half(k),Az_regu(k)
  end do
  ! Bz at half and regular
  write(200+myid,*) "---- Bz(k) at half and regular points ----"
  do k=nz1,nz2
    write(200+myid,"(i6,2es14.5)") k,Bz_half(k),Bz_regu(k)
  end do
  ! Dz at half and regular
  write(200+myid,*) "---- Dz(k) at half and regular points ----"
  do k=nz1,nz2
    write(200+myid,"(i6,2es14.5)") k,Dz_half(k),Dz_regu(k)
  end do
  ! (Az+Dz)*stept at half and regular
  write(200+myid,*) "---- (Az(k)+Dz(k))*stept at half and regular points ----"
  do k=nz1,nz2
    write(200+myid,"(i6,2es14.5)") k,(Az_half(k)+Dz_half(k))*stept,(Az_regu(k)+Dz_regu(k))*stept
  end do
#endif
