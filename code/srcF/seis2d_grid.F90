...
gx(ni1:NTPI+LenFD)=G%x;gz(nk1:NTPK+LenFD)=G%z
do n=1,LenFD
gx(ni1-n)=gx(ni1-n+1)+gx(ni1)-gx(ni1+1)
gz(nk1-n)=gz(nk1-n+1)+gz(nk1)-gz(nk1+1)
gx(NTPX-LenFD+n)=gx(NTPX-LenFD+n-1)+gx(NTPX-LenFD)-gx(NTPX-LenFD-1)
gz(NTPZ-LenFD+n)=gz(NTPZ-LenFD+n-1)+gz(NTPZ-LenFD)-gz(NTPZ-LenFD-1)
end do
...
gtopoz=gzhalf(NTPZ-LenFD)
topogrid=gzhalf(NTPZ-LenFD)
